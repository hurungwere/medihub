  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-[#4285F4]/20 overflow-x-hidden">
      ...
      <main className="pt-24 lg:pt-32 pb-20">
        ...
        {/* Post Grid */}
        <section className="relative z-10 max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-8">
          {blogPosts.map((post, idx) => (
            <article key={idx} className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between text-left group">
